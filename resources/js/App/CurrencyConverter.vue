<template>
    <div>
        <div class="container mb-5 px-3 px-lg-0" :class="[isMobile ? 'w-100' : 'w-50']">
            <div class="d-flex flex-wrap  align-items-center my-5">
                <div class="active-text me-auto mb-3 mb-lg-0">CurrencyConverter</div>
                <a class="btn btn-resume" href="https://github.com/christianuyeh/Currency-Converter" target="_blank" rel="noopener noreferrer"  onclick="this.blur();">
                    <svg
                        class="mr-2"
                        width="15"
                        height="15"
                    ...
                    GitHub</a>
                <a class="btn btn-resume ms-3" onclick="this.blur();">
                    <svg
                        class="mr-2"
                        stroke="currentColor"
                        fill="currentColor"
           ...
           <img
                src="/public/CurrencyConverter2.png"
                class="card-img-top rounded-3 w-100 h-100"
                alt="..."

            />
            <div class="active-text nav-item mt-3">Overview</div>
            ...
            <div class="company-sub">
                Convert currencies instantly with real-time exchange rates from
                around the world. Whether you're traveling, shopping
                internationally, or managing finances, CurrencyConverter helps
                you make informed decisions with up-to-date data and a clean,
                user-friendly interface.
            </div>
            <div class="active-text nav-item mb-1 mt-5">Features</div>

            <div>
                <div class="d-flex">
                    <span class="active-small-nav me-3 mt-2"></span>
                    <p class="company-sub">
                        Live Exchange Rate Charts - Visualize trends over time
                        for smarter conversions
                    </p>
                </div>
                ...
                <div class="d-flex">
                    <span class="active-small-nav me-3 mt-2"></span>
                    <p class="company-sub">
                        Instant Conversion Tool - Swap between currencies with a
                        tap
                    </p>
                </div>
                <div class="d-flex">
                    <span class="active-small-nav me-3 mt-2"></span>
                    <p class="company-sub">
                        Supports 160+ Currencies - Including USD, EUR, GBP, JPY,
                        MYR, and more
                    </p>
                </div>
                <div class="d-flex">
                    <span class="active-small-nav me-3 mt-2"></span>
                    <p class="company-sub">
                        Light & Dark Themes - Choose your preferred look for day
                        or night
                    </p>
                </div>
                <div class="d-flex">
                    <span class="active-small-nav me-3 mt-2"></span>
                    <p class="company-sub">
                        Flag Icons for Easy Recognition - Instantly identify
                        currencies
                    </p>
                </div>
                <div class="d-flex">
                    <span class="active-small-nav me-3 mt-2"></span>
                    <p class="company-sub">
                        Clean and Responsive Design - Optimized for speed and
                        ease of use
                    </p>
                </div>
            </div>
            <div
                class="active-text nav-item mb-1 mt-5"
            ...
            <div class="d-flex">
                <span class="active-small-nav me-3 mt-2"></span>
                <p class="company-sub">Vue Js</p>
            </div>
            <div class="d-flex">
                <span class="active-small-nav me-3 mt-2"></span>
                <p class="company-sub">Tailwind</p>
            </div>
            <div class="d-flex">
                <span class="active-small-nav me-3 mt-2"></span>
                <p class="company-sub">JavaScript</p>
            </div>
            <div class="d-flex">
                <span class="active-small-nav me-3 mt-2"></span>
                <p class="company-sub">Fontawesome</p>
            </div>
            <div class="d-flex">
                <span class="active-small-nav me-3 mt-2"></span>
                <p class="company-sub">Axios</p>
            </div>
            <div class="d-flex">
                <span class="active-small-nav me-3 mt-2"></span>
                <p class="company-sub">Chart js</p>
            </div>
            <div class="d-flex">
                <span class="active-small-nav me-3 mt-2"></span>
                <p class="company-sub">Pretty checkbox</p>
            </div>
        </div>
    </div>
</template>
